...
class StateDataset(Dataset):
    def __init__(self, env_instance: EnvironmentState, transform_f, size=3500000, skip_step=0, include_torque=True):
        self.size = size
    ...
    def __getitem__(self, idx):
        s0 = None
        # not including torques in array
        while not self.include_torque:
        ...
        self.env.step(random_movement= not self.include_torque) # random movement when not include torques
